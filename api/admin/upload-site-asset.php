...
if (!in_array($type, ['logo', 'favicon', 'modal_image', 'header_image'], true)) {
    $type = 'logo';
}
...
try {
    ...
    $keyMap = ['logo' => 'site_logo', 'favicon' => 'site_favicon', 'modal_image' => 'homepage_modal_image', 'header_image' => 'header_image'];
