...
<title><?php echo htmlspecialchars($siteName); ?> | Investment Plans Comparison</title>
...
<body class="bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-100 antialiased font-display overflow-x-hidden">
