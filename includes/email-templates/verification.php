...
<title><?= htmlspecialchars($siteName) ?> | Verify Your Email</title>
</head>
...
<h2 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#1d180c;line-height:1.3">Verify your <?= htmlspecialchars($siteName) ?> account</h2>
