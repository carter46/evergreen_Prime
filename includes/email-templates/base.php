...
$heading = $heading ?? 'Your Bloombit update';
...
<title>Bloombit | Transactional Email</title>
<style>
...
<p style="margin:0 0 4px;font-size:11px;color:#8a8a7d;text-transform:uppercase;letter-spacing:0.1em;font-weight:700">Bloombit Technologies Inc.</p>
...
<p style="margin:0;font-size:11px;color:#8a8a7d">You're receiving this because you're a Bloombit customer. <a href="<?= htmlspecialchars($site_url) ?>/legal_centre" style="color:#5c5c52;text-decoration:underline">Manage Preferences</a> · <a href="<?= htmlspecialchars($site_url) ?>/legal_centre" style="color:#5c5c52;text-decoration:underline">Unsubscribe</a></p>
</div>
</div>
</div>
...
<p style="margin:8px 0 0;font-size:12px;color:#8a8a7d">© <?= date('Y') ?> Bloombit. All rights reserved.</p>
</div>
</div>
</body>
</html>
