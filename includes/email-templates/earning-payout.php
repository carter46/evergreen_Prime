<?php
/**
 * Bloombit - Earning Payout Email Template
 */
$config = $config ?? [];
$site_url = $site_url ?? '/';
...
<title><?= htmlspecialchars($siteName) ?> | Earning Payout</title>
</head>
...
<span style="display:inline-block;padding:6px 12px;background:rgba(34,197,94,0.15);color:#16a34a;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;border-radius:9999px;margin-bottom:20px">Earning Payout</span>
<h2 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#1d180c;line-height:1.3">Your earnings have been credited</h2>
<p style="margin:0 0 16px;color:#5c5c52;font-size:16px">Hi <strong style="color:#1d180c"><?= htmlspecialchars($name) ?></strong>,</p>
<p style="margin:0 0 24px;color:#5c5c52;font-size:16px">Great news! Your investment earnings have been calculated and credited to your account.</p>
<div style="margin:24px 0;padding:20px;background:#f8f8f5;border-radius:8px;border-left:4px solid #16a34a">
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
<span style="color:#5c5c52;font-size:14px;font-weight:600">Earnings Credited:</span>
...
<span style="font-size:18px;font-weight:600;color:#1d180c">$<?= number_format((float)$amountUsd, 2, '.', ',') ?></span>
</div>
<?php endif; ?>
<div style="margin-top:12px;padding-top:12px;border-top:1px solid #e5e5e0">
<span style="color:#5c5c52;font-size:12px">From Plan:</span>
<span style="color:#1d180c;font-size:14px;font-weight:600"><?= htmlspecialchars($planName) ?></span>
</div>
</div>
<p style="margin:24px 0;color:#5c5c52;font-size:16px">Your earnings have been automatically added to your wallet balance and are available for withdrawal or reinvestment.</p>
