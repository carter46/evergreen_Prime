...
<span style="display:inline-block;padding:6px 12px;background:rgba(34,197,94,0.15);color:#16a34a;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;border-radius:9999px;margin-bottom:20px">Earning Accrued</span>
<h2 style="margin:0 0 24px;font-size:28px;font-weight:700;color:#1d180c;line-height:1.3">Your earnings have been accrued</h2>
<p style="margin:0 0 16px;color:#5c5c52;font-size:16px">Hi <strong style="color:#1d180c"><?= htmlspecialchars($name) ?></strong>,</p>
<p style="margin:0 0 24px;color:#5c5c52;font-size:16px">Great news! Your investment earnings have been calculated and added to your plan balance.</p>
<div style="margin:24px 0;padding:20px;background:#f8f8f5;border-radius:8px;border-left:4px solid #16a34a">
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
<span style="color:#5c5c52;font-size:14px;font-weight:600">Earnings Accrued:</span>
...
<p style="margin:24px 0;color:#5c5c52;font-size:16px">These earnings are held on your active plan and will be released to your wallet when the plan matures, is liquidated, or is cancelled by an administrator.</p>
