...
<p style="margin:0 0 24px;color:#a18a45;font-size:14px;line-height:1.6">No worries, it happens. We received a request to reset the password for your <?= htmlspecialchars($siteName) ?> account.</p>
...
<p style="margin:12px 0 0;font-size:12px;color:#8a8a7d">© <?= date('Y') ?> <?= htmlspecialchars($siteName) ?>. All rights reserved.</p>
</div>
</div>
</div>
</body>
