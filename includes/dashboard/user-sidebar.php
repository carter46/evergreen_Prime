...
<!-- Sidebar -->
<aside id="user-sidebar" class="fixed lg:static inset-y-0 left-0 w-64 border-r border-primary/10 bg-white/50 dark:bg-background-dark/50 flex flex-col shrink-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-200 ease-out h-full">
